...
<head>
    ...
    <title>Insert | data spare parts | CRUD </title>
</head>
<body>
...
<div class="container">
   <div class="row my-3">
       <div class="col-md">
           <h2><i class="bi bi-file-earmark-plus-fill" style="color:green;"></i>&nbsp;Insert data spare part</h2>
       </div>
       <hr>
   </div>
   <div class="row mb-3">
       <div class="col-md">
           ...
           <div class="mb-3">
                ...
                <input type="number" class="form-control w-50" id="kode" placeholder="Item code" name="kode" autocomplete="off" required="">
            </div>
           <div class="mb-3">
                <label for="old" class="form-label">Old Text</label>
                <input type="text" class="form-control w-50" id="old" placeholder="Old Description" name="'old" autocomplete="off">
            </div>
            <div class="mb-3">
                <label for="long" class="form-label">Long Text</label>
                <input type="text" class="form-control w-50" id="long" placeholder="Long Description" name="long" autocomplete="off">
            </div>            
            <div class="mb-3">
                <label for="loc" class="form-label">Location</label>
                <input type="text" class="form-control w-50" id="loc" placeholder="Location" name="loc" autocomplete="off">
            </div>
            <div class="mb-3">
                <label for="qty" class="form-label">Qty</label>
                <input type="number" class="form-control w-50" id="qty" placeholder="Qty" name="qty" autocomplete="off">
            </div>
            <div class="mb-3">
                <label for="uom" class="form-label">Uom</label>
                <input type="text" class="form-control w-50" id="uom" placeholder="Uom" name="uom" autocomplete="off">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control w-50" id="maxi" placeholder="Max" name="maxi" autocomplete="off">
            </div>
            <div class="mb-3">
                <label for="rop" class="form-label">Rop</label>
                <input type="number" class="form-control w-50" id="rop" placeholder="Rop" name="rop" autocomplete="off">
            </div>
            <div class="mb-3">
                <label for="mini" class="form-label">Min</label>
                <input type="number" class="form-control w-50" id="mini" placeholder="Min" name="mini" autocomplete="off">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="text" class="form-control w-50" id="email" placeholder="email" name="email" autocomplete="off">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control w-50" id="ket" rows="4" name="ket" placeholder="Remarks"></textarea>
            </div>      
            <hr>
            <button type="button" name="tambah" class="btn btn-primary">Save</button>   
